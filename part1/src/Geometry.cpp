...
void Geometry::AddVertex2(float x, float y, float z, float xn, float yn, float zn, float s, float t){
	m_vertexPositions.push_back(x);
	m_vertexPositions.push_back(y);
	m_vertexPositions.push_back(z);
    // Add texture coordinates
...
void Geometry::MakeTriangle2(unsigned int vert0, unsigned int vert1, unsigned int vert2){
	m_indices.push_back(vert0);	
	m_indices.push_back(vert1);	
	m_indices.push_back(vert2);	
