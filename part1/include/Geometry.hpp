...
public:
	...
	void AddVertex2(float x, float y, float z, float xn, float yn, float zn, float s, float t);
	...
	void MakeTriangle2(unsigned int vert0, unsigned int vert1, unsigned int vert2);  
